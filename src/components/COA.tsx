        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-6xl mx-auto">
          {coaReports.length === 0 ? (
            <div className="col-span-2 text-center py-20">
              ...
              <p className="text-xl text-charcoal-400">No lab reports available yet.</p>
            </div>
          ) : (
            coaReports.map((report) => (
              ...
              >
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-sky-600/0 group-hover:bg-blush-700/10 transition-all duration-300 flex items-center justify-center">
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-charcoal-900/95 backdrop-blur-sm px-3 py-1.5 md:px-4 md:py-2 rounded-xl md:rounded-2xl shadow-lg">
                      <p className="text-xs md:text-sm font-bold text-glow-teal-400 flex items-center gap-1.5 md:gap-2">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 md:gap-2 text-sm md:text-base text-glow-teal-400 hover:text-glow-teal-300 font-medium"
                  >
                    <span>Janoshik</span>
