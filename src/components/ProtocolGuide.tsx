        ...
        <div className="min-h-screen bg-theme-bg">
            ...
            <main className="container mx-auto px-4 py-8 max-w-4xl">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-charcoal-800 border border-charcoal-700 shadow-soft mb-4">
                        <BookOpen className="w-4 h-4 text-rose-500" />
                        <span className="text-xs font-medium text-charcoal-200 uppercase tracking-widest">Protocol Guide</span>
                    </div>
                    <h1 className="font-heading text-3xl sm:text-4xl font-bold text-charcoal-800 mb-3">
                ...
                {/* General Guidelines */}
                <div className="bg-white rounded-2xl shadow-soft border border-charcoal-200 p-6 mb-8">
                    <h2 className="font-heading text-xl font-semibold text-charcoal-800 mb-4 flex items-center gap-2">
                ...
                <div className="bg-white rounded-2xl shadow-soft border border-charcoal-200 p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                        <div className="bg-charcoal-50 border border-charcoal-200 rounded-xl p-4">
                ...
                <div className="mb-6">
                    ...
                    <select
                        ...
                        className="w-full sm:w-64 px-4 py-3 rounded-xl bg-white border border-charcoal-200 text-charcoal-800 font-medium shadow-soft focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all cursor-pointer"
                    >
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-2xl shadow-soft border border-charcoal-200 p-8 text-center">
                    ...
                    <div className="space-y-4">
                        {filteredProtocols.map((protocol) => (
                            <div
                                key={protocol.id}
                                className="bg-white rounded-2xl shadow-soft border border-charcoal-200 overflow-hidden"
                            >
                                <button
                                    onClick={() => toggleProtocol(protocol.id)}
                                    className="w-full p-5 flex items-center justify-between text-left hover:bg-charcoal-50 transition-colors"
                                >
                                    <div>
                                        <span className="text-xs font-medium text-rose-500 uppercase tracking-wider">{protocol.category}</span>
                                        <h3 className="font-heading text-lg font-semibold text-charcoal-800 mt-1">{protocol.name}</h3>
                                    </div>
                                ...
                                {expandedProtocol === protocol.id && (
                                    <div className="px-5 pb-5 border-t border-charcoal-200">
                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4 mb-4">
                                            <div className="bg-charcoal-50 border border-charcoal-200 rounded-xl p-3">
